...
import { Trash2, Search, Filter, Heart, MapPin, Bed, Bath, Square, LogOut, User, Eye, Home, Shield } from 'lucide-react';
...
const PropertyCard = ({ property, onViewDetails }) => {
  ...
  className="absolute top-2 right-2 p-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition opacity-0 group-hover:opacity-100"
>
